...
// +kubebuilder:rbac:groups=cache.gallowayhq.com,resources=memcached,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.gallowayhq.com,resources=memcached/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.gallowayhq.com,resources=memcached/finalizers,verbs=update
